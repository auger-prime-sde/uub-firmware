...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = digital_interface
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = digital_interface_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = interface_uub_dfn3
 PARAMETER DRIVER_VER = 1.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = rd_interface
 PARAMETER DRIVER_VER = 2.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = test_control
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = test_control_block_test_control_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = time_tagging
 PARAMETER DRIVER_VER = 1.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sde_trigger
 PARAMETER DRIVER_VER = 1.0
