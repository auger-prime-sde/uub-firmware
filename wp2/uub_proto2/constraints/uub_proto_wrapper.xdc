set_property DONT_TOUCH true [get_cells uub_proto2_i/zync_block/processing_system7_0/inst]
set_property DONT_TOUCH true [get_cells uub_proto2_i/zync_block/processing_system7_0]
set_property DONT_TOUCH true [get_cells uub_proto2_i]
