    ...
    if ((SHWR_INTR_PEND_MASK & (shwr_status >> SHWR_INTR_PEND_SHIFT)) != 0)
      {
        ...
        area_peak[nevents][0] = read_trig(SHWR_PEAK_AREA0_ADDR);
        area_peak[nevents][1] = read_trig(SHWR_PEAK_AREA1_ADDR);
        area_peak[nevents][2] = read_trig(SHWR_PEAK_AREA2_ADDR);
        area_peak[nevents][3] = read_trig(SHWR_PEAK_AREA3_ADDR);
        area_peak[nevents][4] = read_trig(SHWR_PEAK_AREA4_ADDR);
        area_peak[nevents][5] = read_trig(SHWR_PEAK_AREA5_ADDR);
        area_peak[nevents][6] = read_trig(SHWR_PEAK_AREA6_ADDR);
        area_peak[nevents][7] = read_trig(SHWR_PEAK_AREA7_ADDR);
        area_peak[nevents][8] = read_trig(SHWR_PEAK_AREA8_ADDR);
        area_peak[nevents][9] = read_trig(SHWR_PEAK_AREA9_ADDR);
